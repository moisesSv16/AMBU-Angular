...
@Component({
  selector: 'app-incidencia-seguridad',
  templateUrl: './incidencia-seguridad.component.html',
  styleUrls: ['./incidencia-seguridad.component.css']
})
export class IncidenciaSeguridadComponent implements OnInit {
  ...
  @ViewChild('table_seguridad', { static: false }) table: ElementRef | undefined;
  ...
  obtenerRegistros(): void {
    try {
      this.seguridadService.obtenerRegistros()
        .subscribe(
          (data: any) => {
  ...
  navigateToDetails(id: number): void {
    this.router.navigate(['/seguridad-datos', id]);
  }
}
