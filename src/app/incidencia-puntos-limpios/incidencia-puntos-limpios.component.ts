...
@Component({
  selector: 'app-incidencia-puntos-limpios',
  templateUrl: './incidencia-puntos-limpios.component.html',
  styleUrls: ['./incidencia-puntos-limpios.component.css']
})
export class IncidenciaPuntosLimpiosComponent implements OnInit {
  ...
  @ViewChild('table_puntos_limpios', { static: false }) table: ElementRef | undefined;
  ...
  obtenerRegistros(): void {
    try {
      this.puntosLimpiosService.obtenerRegistros()
        .subscribe(
          (data: any) => {
  ...
  navigateToDetails(id: number): void {
    this.router.navigate(['/puntos-limpios-datos', id]);
  }
}
