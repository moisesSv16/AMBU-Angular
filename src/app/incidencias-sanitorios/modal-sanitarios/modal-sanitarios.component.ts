...
import { SharedDataService } from '../shared-data-sanitarios.service';


@Component({
  selector: 'app-modal-sanitarios',
  templateUrl: './modal-sanitarios.component.html',
  styleUrl: './modal-sanitarios.component.css'
})
export class ModalSanitariosComponent {
  selectedId: string = '';
  selectedDesc: string = '';
  selectedImg: string = '';
